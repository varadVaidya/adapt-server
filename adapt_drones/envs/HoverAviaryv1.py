...
class HoverAviaryv1(BaseAviary):
    """
    Simple Hover Environment. The goal is to go from
    the initial position to the final position and hover there. This
    environment includes the additional dynamics info in the observation
    space.
    """
    ...
    def __init__(
        ...
        self.priv_info_shape = self.get_dynamics_info().shape
